...
const Updatenote = () => {
    ...
    const fdata = async (params) => {
        const { data } = await axios.get(`http://localhost:3000/notes/${noteid}`)
        setformdata(data)
    }
    useEffect(() => {
        fdata()
    ...
    const handelform = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(`http://localhost:3000/notes/${noteid}`, formdata)
        ...
        <div className=" h-full w-[50%] flex items-center justify-center ">
            ...
            <form className="w-[400px] bg-white shadow-xl rounded-2xl p-8 space-y-6" onSubmit={handelform}>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <textarea name='desc' onChange={handelinput} value={formdata.desc}
